...
#==================================BUTTONS WIDGET=====================================
btn_agree = Radiobutton(Buttons, width=10, text="I agree", variable=v, value=1, command=valide)
btn_agree.pack(side=LEFT)
btn_disagree = Radiobutton(Buttons, width=10, text="I disagree", variable=v, value=2, command=valide)
btn_disagree.pack(side=LEFT)
btn_exit = Button(Buttons, width=10, text="Valide", state=DISABLED, command=exit)
btn_exit.pack(side=BOTTOM)

#==================================LIST WIDGET========================================
scrollbary = Scrollbar(Middle, orient=VERTICAL)
text = Text(Middle, height=400,width=900, yscrollcommand=scrollbary.set)
