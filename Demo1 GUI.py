...
#==================================BUTTONS WIDGET=====================================
btn_create = Button(Buttons, width=10, text="Text1", command=DISABLED)
btn_create.pack(side=LEFT)
btn_read = Button(Buttons, width=10, text="Text2", command=DISABLED)
btn_read.pack(side=LEFT)
btn_update = Button(Buttons, width=10, text="Text3", state=DISABLED)
btn_update.pack(side=LEFT)
btn_delete = Button(Buttons, width=10, text="Text4", state=DISABLED)
...
#tree = ttk.Treeview(Right, columns=("Salary", "TaxCode", "National Insurance"), selectmode="extended", height=500, yscrollcommand=scrollbary.set, xscrollcommand=scrollbarx.set)
